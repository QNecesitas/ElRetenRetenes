...
import com.qnecesitas.elretenretenes.databinding.ActivitySettingsBinding
import com.qnecesitas.elretenretenes.viewmodels.SettingsViewModel
import com.qnecesitas.elretenretenes.viewmodels.SettingsViewModelFactory
...
private fun checkInfoPassword(){
    ...
    if(binding.tietPasswAdminConfirm.text.toString() !=
        ...
        result =false
        binding.tietPasswAdminConfirm.error = (getString(R.string.no_coinciden_la_contrase_a_a_confirmar_y_la_nueva))
    }else{
        binding.tietPasswAdminConfirm.error = null
    }
